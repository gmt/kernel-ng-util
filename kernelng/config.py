...
def KNGExampleConfigData():
    ...
    result['sys-kernel/gentoo-sources'] = (
        ...
        '# example if we put name_override = %(prog)s in the',
        '# [sys-kernel/gentoo-sources] section, then the overlay package',
        '# mirroring sys-kernel/gentoo-sources generated by %(progdesc)s',
        '# would be named sys-kernel/%(prog)s.',
        '',
